...
WP Native Translations is a deliberately small multilingual plugin. It manages translations of
...
`wpnt_model_preference` filter. Temperature is omitted by default (some models reject
it) and can be supplied with the `wpnt_temperature` filter.

== Installation ==

1. Upload the `native-translations` folder to `/wp-content/plugins/`, or install through the
   Plugins screen.
2. Activate the plugin.
3. Go to the **WP Native Translations** menu and configure your languages, the default language,

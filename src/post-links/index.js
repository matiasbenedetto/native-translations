/**
 * WP Native Translations — "Translation Links" block (editor side).
 *
...
const NAME = 'native-translations/post-links';
		...
		<div { ...blockProps }>
			<InspectorControls>
				<PanelBody title={ __( 'Display', 'native-translations' ) }>
					...
					/>
					<ToggleControl
						label={ __( 'Include the current language', 'native-translations' ) }
